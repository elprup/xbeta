...
export default function ListLayoutWithTags({
  ...
  if (groupBy === 'tags') {
    ...
    title = categoryConfig[title] ? categoryConfig[title][0] : title
  }
    ...
    <>
      <div>
        <div className="pb-6 pt-6">
          <h1 className="text-center text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-4xl md:leading-14">
            {groupBy === 'tags' ? '#' : ''}
            {title}
          </h1>
        </div>
